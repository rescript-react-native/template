...
/*
 ...
 More at https://rescript-react-native.github.io/en/docs/apis/Style/
 */
let styles = {
  open Style
  StyleSheet.create({
  ...
  <SafeAreaView>
    <ScrollView contentInsetAdjustmentBehavior=#automatic style={styles["scrollView"]}>
      ...
      <View style={styles["body"]}>
        ...
        <View style={styles["sectionContainer"]}>
          <Text style={styles["sectionDescription"]}>
            <Text style={styles["highlight"]}> {"ReScript React Native"->React.string} </Text>
          </Text>
          <TouchableOpacity
            onPress={_ => openURLInBrowser("https://rescript-react-native.github.io/en/docs/")}>
            <Text
              style={
                open Style
                style(
              ...
              {"https://rescript-react-native.github.io/"->React.string}
            </Text>
          </TouchableOpacity>
        </View>
        <View style={styles["sectionContainer"]}>
